<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="填报状态: 0-待填报 1-草稿 2-已提交" prop="reportStatus">
        <el-radio-group v-model="formData.reportStatus">
          <el-radio value="1">请选择字典生成</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="填报完成度(%)" prop="completionRate">
        <el-input v-model="formData.completionRate" placeholder="请输入填报完成度(%)" />
      </el-form-item>
