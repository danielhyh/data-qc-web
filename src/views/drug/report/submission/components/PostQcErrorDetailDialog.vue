...
<template>
  <Dialog
    ...
    destroy-on-close
    class="post-qc-error-detail-dialog"
  >
...
const exportErrors = () => {
  ...
  try {
    ...
    csvContent += '序号,规则编码,规则名称,错误类型,表类型,错误详情,Excel行号\n'
